<!-- ====== HEADER ====== -->
<p align="center">
  <img src="./banner.png?v=1776912296" width="100%" />
</p>
...
<p>
  ...
  <img src="https://img.shields.io/badge/GCD-0ea5e9" />
...
|---|---|---|---|
| **Task Planner** | Production-level productivity app with recurring tasks, statistics, widgets, and subscription model | SwiftUI, SwiftData, Clean Architecture, WidgetKit, StoreKit | App Store (coming soon) |
