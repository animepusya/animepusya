...
|---|---|---|---|
| **Mind Widgets** | Mind Widgets is an iOS app that helps users keep important thoughts, ideas, and reminders visible through customizable Home Screen widgets. | SwiftUI, SwiftData, MVVM, Foundation Models, WidgetKit, CoreGraphics | Private Development |
